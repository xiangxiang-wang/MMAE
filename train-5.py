...
def train(train_loader, args):
    ...
    log_dir = model_dir + "epoch_86_loss_0.189574.pth"  ###若需从断点处继续，需要更改此文件为上一次的epoch
...
def parse_args():
    ...
    parser.add_argument('--dataset_dir', type=str, default=r"F:\train_dataset\CVC-14\Train")
    parser.add_argument('--saveModel_dir', type=str, default=r'E:/MMAE/save_model_cvc14/')
